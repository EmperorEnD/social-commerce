            ...
            <div id="tab-container">
                <ul>
                 <li class="selected"><a href="">Latest</a></li>
                    ...
                    <li class="selected"><a href="">Gadgets&goods</a></li>
                    <li class="selected"><a href="">Gigs&tickets</a></li>
                    <li class="selected"><a href="">Art&entertainment</a></li>
                    <li class="selected"><a href="">School Stuff</a></li>
                    <li class="selected"><a href="">Academic Services</a></li>
                    <li class="selected"><a href="">Rides&Accomodation</a></li>
...
<body>
  <a href="posttoevents&tickets.php" class="action-button shadow animate orange">Post!</a>
...
{
	echo"<div class='feed-box'><h class='feed-title'>".$row['market']."<br>Price/unit: R".$row['ask_price']."<br>Post by: ".$row['vendor']."</h><br>
	<a class='feed-date'>Date: ".date("j F Y", strtotime($row['date']))."</a>
	<br><a class='feed-item'>Additional info: ".$row['description']."
       
        <br> Units available: ".$row['units']."
        
        <br>".date("H:i:s j/n/Y", strtotime($row['log']))."
                <a class='feed-par'> <p><span>reserve</span>!</p> </a>
                </div>"; 
}
