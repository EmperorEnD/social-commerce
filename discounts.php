...
<li><a href="contact.php">Support</a></li>     </div>
            ...
            <div id="tab-container">
                <ul>
                 <li class="selected"><a href="">Latest</a></li>
                    ...
                    <li class="selected"><a href="">Food</a></li>
                   
                    <li class="selected"><a href="">Travel</a></li>
                    <li class="selected"><a href="">Lifestyle</a></li>
...
<div id="main-container">
		...
		<a href="contact.php" class="action-button shadow animate orange">Post!</a>

							
	
<img src="xxxx/pictures/traveld.jpg">
</div>
</div></div></div></div>
</div>
</html>